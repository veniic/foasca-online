import { cardId, isSpecialJack, RANK_POWER } from '@foaica/shared';
 ...
 */
export function getValidCards(hand, leadSuit, trumpSuit, noTrump) {
 ...
 */
export function determineTrickWinner(plays, leadSuit, trumpSuit, noTrump) {
    if (plays.length === 0) {
